package com.defrox.defroxframe.providers.audio.player.media;
...
import com.defrox.defroxframe.providers.audio.player.remote.RemoteControlClientCompat;
import com.defrox.defroxframe.providers.audio.player.remote.RemoteControlHelper;
...
public class MediaSessionWrapper {
     ...
     */
    static final String ACTION_TOGGLE_PLAYBACK = "com.defrox.defroxframe.providers.soundcloud.library.media.TOGGLE_PLAYBACK";
     ...
     * Action used to catch broadcast from {@link MediaSessionReceiver}
     */
    static final String ACTION_PREVIOUS_TRACK = "com.defrox.defroxframe.providers.soundcloud.library.media.PREVIOUS_TRACK";
